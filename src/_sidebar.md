...
- [Grid](grid_why.md)
  ...
  - [Farming Program](farming_progam.md)
    ...
    - [Certified Farm](farming_certified.md)
    - [DIY Farm](farming_diy.md)
  ...
  - [Farm Setup & Management](farm_setup_management.md.md)
      - [Get 3bot Connect](get_3bot_connect.md)
      - [Install SDK](install_sdk.md)
    - [Configure TFT Wallet](configure_wallet.md)
    - [Create Farm ID](create_farm_id.md)
    - [Create Bootable Image](create_bootable_image.md)
    - [Boot Your 3Node](boot_3node.md)
    - [Manage Farm & Nodes](manage_farm_nodes.md)
