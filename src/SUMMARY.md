...
- [Grid](grid.md)
	...
	- [Frequently Asked Questions](grid_faq.md)
      ...
      - [Token Related](tokens.md)
        - [Token Vesting Scheme](token_vesting_schemes.md)
      - [Demand & Supply](market.md)
        - [Is there a simple way to explain the 30% capacity rule for farming income?](capacity_contract.md)
        - [How to search for capacity?](threefold_directory.md)
      - [Grid Operation FAQ](operations.md)
        - [What is certified hardware](certified.md)
        - [What connectivity is required](connectivity_requirements.md)
        - [How does data storage work in the TF grid?](storage_principles.md)
        - [What are ThreeFold grid applications](applications.md)
        - [How does redundancy work](redundancy.md)
        - [Do you use RAID?](raid.md)
        - [What are typical node workloads](node_workloads.md)
        - [How do we protect users from malicious 3bot code?](malicious_3bot.md)      
      - [Legal](legal.md)
        - [Farmer Liability and Insurance](liability.md)
        - [What about malicious content](malicious_content.md)
      - [Generic](generic.md)
        - [Vienna Cherry Chapter Questions](vcc_faq.md)
	- [Concepts](grid_concepts.md)
      - [Farming Rules](farming_token_geration_rules.md)
      - [Cloud Units](cloud_units.md)
      - [Resource Units](resource_units.md)
      - [Commercial Token Value Calculation](commercial_token_value_calculation.md)
      - [TFT Price at Start Farming](tfprice_farming.md)
      - [TF Period](farming_period_definition.md)
      - [Capacity types](capacity_types.md)
...
- [Token](token.md)
	...
	- [How to buy ThreeFold Tokens](how_to_buy.md)
      - [Buy TFT: BTC-Alpha](tft_btc_alpha.md)
      - [Buy TFT: Over The Counter](tft_mazraa.md)
